import { r as r$1, x } from "./index-jIKUKRM8.js";
const n = (t) => document.querySelector(`${t}.ion-cloned-element`), a = (t) => t.shadowRoot || t, s = (t) => {
  ...
  const w = a(r2).querySelector("ion-icon").getBoundingClientRect(), k = s2 ? w.width / 2 - (w.right - i2.right) + "px" : i2.left - w.width / 2 + "px", T = s2 ? `-${window.innerWidth - i2.right}px` : `${i2.left}px`, A = `${d.top}px`, B = `${i2.top}px`, j = e2 ? [{ offset: 0, transform: `translate3d(${T}, ${B}, 0)` }, { offset: 1, transform: `translate3d(${k}, ${A}, 0)` }] : [{ offset: 0, transform: `translate3d(${k}, ${A}, 0)` }, { offset: 1, transform: `translate3d(${T}, ${B}, 0)` }], z = e2 ? [{ offset: 0, opacity: 1, transform: g }, { offset: 1, opacity: 0, transform: h }] : [{ offset: 0, opacity: 0, transform: h }, { offset: 1, opacity: 1, transform: g }], I = e2 ? [{ offset: 0, opacity: 1, transform: "scale(1)" }, { offset: 0.2, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 0, transform: "scale(0.6)" }] : [{ offset: 0, opacity: 0, transform: "scale(0.6)" }, { offset: 0.6, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 1, transform: "scale(1)" }], N = r$1(), O = r$1(), S = r$1(), C = n("ion-back-button"), R = a(C).querySelector(".button-text"), U = a(C).querySelector("ion-icon");
  ...
  var d, $;
  const u = a2 ? "right" : "left", b = a2 ? `calc(100% - ${r2.right}px)` : `${r2.left}px`, m = `${r2.top}px`;
